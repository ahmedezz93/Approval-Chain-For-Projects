...
- **Release 1.2.4**
    - Added POST endpoint to update or create an approval chain for a project: A new endpoint (/api/projects/{projectId}/updateOrCreateChain) was added to enable updating or creating an approval chain for a specific project.

    - Added PUT endpoint to approve the approval chain: A new endpoint (/api/projects/{projectId}/approveChain) was added to approve the approval chain for a specific project.

    - Added GET endpoint to retrieve approval chain details for a project: A new endpoint (/api/projects/{projectId}/approvalChain) was added to retrieve the approval chain details for a specific project.
